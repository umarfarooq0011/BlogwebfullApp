...
const Footer = () => {
  return (
    <footer className="bg-[#0d172b] text-slate-300 mt-20 pt-16 pb-8 px-2 sm:px-4 md:px-12 shadow-inner w-full">
      <div className="max-w-7xl mx-auto grid grid-cols-1 gap-10 xs:grid-cols-2 sm:grid-cols-2 md:grid-cols-4">
        {/* Logo & About */}
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li><a href="#" className="hover:text-white transition duration-150">Explore Topics</a></li>
            <li><a href="#" className="hover:text-white transition duration-150">Contact Us</a></li>
          </ul>
        </div>
        {/* Resources */}
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li><a href="#" className="hover:text-white transition duration-150">Terms of Use</a></li>
        ...
        <div className="flex flex-col items-start">
          ...
          <ul className="flex flex-wrap gap-4 example-2 justify-center sm:justify-start">
            <li className="icon-content">
              <a data-social="whatsapp" aria-label="Whatsapp" href="https://api.whatsapp.com/send?phone=+112067101079&text=Save%20this%20to%20your%20Favorites%20-%20@wilsondesouza" target="_blank" rel="noopener noreferrer">
                <div className="filled" />
                <svg xmlSpace="preserve" viewBox="0 0 24 24" fill="currentColor" height="30" width="30">
            ...
            <li className="icon-content">
              <a data-social="instagram" aria-label="Instagram" href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer">
                <div className="filled" />
                <svg xmlSpace="preserve" viewBox="0 0 16 16" fill="currentColor" height="30" width="30">
      ...
      <div className="mt-12 border-t border-slate-700 pt-6 text-center text-xs text-slate-500">
        <p>&copy; {new Date().getFullYear()} Insight Sphere. All rights reserved.</p>
        <p className="mt-2">Built with ❤️ by <a href="https://omer-awan.netlify.app/">OMER AWAN</a></p>
      </div>
      <style>{`
  .example-2 {
    display: flex;
